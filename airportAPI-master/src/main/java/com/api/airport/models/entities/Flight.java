...
public class Flight {
    ...
    @ManyToOne
    @JoinColumn(name = "DEPARTURE_AIRPORT_CODE", foreignKey = @ForeignKey(name = "FK_DEPARTURE_AIRPORT"))
    private Airport departureAirport;
    
    @ManyToOne
    @JoinColumn(name = "ARRIVAL_AIRPORT_CODE", foreignKey = @ForeignKey(name = "FK_ARRIVAL_AIRPORT"))
