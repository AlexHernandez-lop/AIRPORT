...
public class SeatReservationController {
        ...
        //@CrossOrigin(origins = "http://localhost:4200")
        public ResponseEntity<List<SeatReservation>> getSeatReservationByPhone(@PathVariable String customerPhone) {
                List<SeatReservation> seatReservations = seatReservationService.findByCustomerPhone(customerPhone);
